/**
 * Created by fsalavert on 11/05/14.
 */
/*
...
function Potyvirus(args) {
    ...
    var _this = this;
    this.id = Utils.genId("Potyvirus");

    //set default args
    this.suiteId = "Potyvirus";
